...
![The PEQ Editor NPC tab](../../../.gitbook/assets/peq\_database\_editor.png)
...
![tutorialb is the selected zone](../../../.gitbook/assets/peq\_database\_editor-2.png)
...
![Enter level 1 and click Submit](../../../.gitbook/assets/peq\_database\_editor-3.png)
...
![Default settings for our new NPC](../../../.gitbook/assets/peq\_database\_editor-5.png)

Explanations for each of these fields can be found on the [npc\_types](https://eqemu.gitbook.io/database-schema/categories/npcs/npc\_types) page (opens new window) in the Database Schema documentation. &#x20;

For our Server Greeter Bot, we are going to input the NPC Name as "_**Salutation\_Model\_XIV**_", select the **457 - Gnomework** _race_, with a **5 - Construct** _bodytype_ setting, _gender_ **Neuter**. These options will cause the NPC to display correctly to the client.  Be sure to also place a checkmark in the following boxes:  **Will Not Aggro (24)**, **Immune to Aggro (25)**, and **Has Quest File**.  The rest of the settings are entirely up to you.  You can choose to match the settings below for the purposes of this guide.  We do want our Greeter Bot to be noticeable, so we have increased the _size_ to **10**.  We also don't want our Greeter Bot to be accidentally killed, so we have made the NPC quite resilient by granting ridiculous HP and resist. &#x20;
...
![Your first NPC!](../../../.gitbook/assets/peq\_database\_editor-6.png)
...
![The Spawns tab has all of the information regarding the spawning of your NPC](../../../.gitbook/assets/peq\_database\_editor-7.png)
...
![Default Spawngroup settings](../../../.gitbook/assets/peq\_database\_editor-8.png)

As with the Add an NPC step above, many values are pre-populated in the PEQ Editor to help you out.  Leave the default values and click the _Submit_ button.
...
![No Spawnpoint](../../../.gitbook/assets/peq\_database\_editor-9.png)

Click the _Add Spawnpoint to this Spawngroup_ link.

![The Spawnpoint editing page in the PEQ Editor](../../../.gitbook/assets/peq\_database\_editor-10.png)
...
![Your Spawnpoint settings](../../../.gitbook/assets/peq\_database\_editor-16.png)
...
![Review your Spawnpoint settings](../../../.gitbook/assets/peq\_database\_editor-17.png)
...
The Pathing Grid has Wander types, Pause types, and a listing of Waypoints that your NPC will follow.  To review the Grid fields in your database, reference the [grid](https://eqemu.gitbook.io/database-schema/categories/grids/grid) page (opens new window) in the Database Schema documentation.  For information regarding the Waypoint entry fields in your database, reference the [grid\_entries](https://eqemu.gitbook.io/database-schema/categories/grids/grid\_entries) page (opens new window).

Since we have not defined any information about this particular Pathing Grid, we will do so now.

![A blank pathing Grid](../../../.gitbook/assets/peq\_database\_editor-18.png)
...
![Walk through each Waypoint and Pause for the full amount set](../../../.gitbook/assets/peq\_database\_editor-14.png)
...
![Your Waypoint Entry](../../../.gitbook/assets/peq\_database\_editor-20.png)
...
![Complete!](../../../.gitbook/assets/peq\_database\_editor-21.png)
...
![Salutation Model XIV](../../../.gitbook/assets/salutation\_model\_xiv.jpg)
